    ...
    class User : IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        public string NameError
        {
            ...
            set
            {
                ...
                {
                    nameError = value;
                    OnPropertyChanged("NameError"); //It is used to fire the event
                }
            }
        }
        ...
        public string this[string columnName] //ColumnName is the name of the property whose error message to get
        {
            get
            {
                NameError = "";
